...
```text
帮我安装 windows-ai-cli-recovery：https://raw.githubusercontent.com/Fable-Forge/windows-ai-cli-recovery/main/docs/install.md
```
...
- 🐛 Bug 与功能建议：[windows-ai-cli-recovery Issues](https://github.com/Fable-Forge/windows-ai-cli-recovery/issues)
